        ...
        <div>
            {budgetList.length > 0 ? (
                <div>
                    ...
                    {/* card is made in the following 4 divs all same */}
                    <div className='mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                        <div className='p-7 border rounded-2xl flex items-center justify-between'>
                            ...
                            <PiggyBank className='bg-blue-800 p-3 h-12 w-12 rounded-full text-white'></PiggyBank>
                        </div>
                    </div>
                    ...
                    <div className='mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                        <div className='p-7 border rounded-2xl flex items-center justify-between'>
                            ...
                            <ReceiptText className='bg-blue-800 p-3 h-12 w-12 rounded-full text-white'></ReceiptText>
                        </div>
                    </div>
                    ...
                    <div className='mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                        <div className='p-7 border rounded-2xl flex items-center justify-between'>
                            ...
                            <Wallet className='bg-blue-800 p-3 h-12 w-12 rounded-full text-white'></Wallet>
                        </div>
                    </div>
                    ...
                    <div className='mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                        <div className='p-7 border rounded-2xl flex items-center justify-between'>
                            ...
                            <CircleDollarSign className='bg-blue-800 p-3 h-12 w-12 rounded-full text-white'></CircleDollarSign>
                        </div>
                    </div>
